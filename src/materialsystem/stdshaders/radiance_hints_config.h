...
// Older packages exposed RH render-target names from
// deferred_global_common.h. Remove every legacy definition locally before
// declaring the RH 4 names. This keeps the shared header untouched and avoids
// C4005 when warnings are treated as errors.
