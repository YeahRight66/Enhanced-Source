...
ConVar deferred_radiosity_enable( "deferred_radiosity_enable", "1", FCVAR_ARCHIVE,
	"Compatibility alias: master-enable daylight GI." );
ConVar deferred_radiosity_debug( "deferred_radiosity_debug", "0", FCVAR_NONE,
	"Compatibility alias: show first-bounce daylight GI, bounds, and statistics." );
